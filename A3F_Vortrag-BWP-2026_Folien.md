...
![PKM in DigComp 2.2 – enthalten, nicht adressiert](Assets/digcomp.png)
...
![Studentin A sieht B und C bei der Arbeit](Assets/visual-studierende.png)
...
![Fünf Stufen nach Rogers → Zweiteilung nach Riar et al. → drei Phasen mit Gabel Adoption/Ablehnung](Assets/rogers-phasen.png)
...
![Matrix-Schema: sechs Praktiken plus Platzhalter „offen“ als Spalten, drei Phasen und „nicht adoptiert“ als Zeilen](Assets/matrix-lernende.png)

---

### Praxis = das Muster

![Praxis-Profil von A: sechs Balken in der Matrix, ein Kreis in der Zeile „nicht adoptiert“](Assets/praxis-profil.png)
